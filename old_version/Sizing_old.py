from old_version.param import delta_t, C_pv_max, C_bss_max
...
from old_version.param import PI_c_pv, PI_c_bss, PI_c_inv, PI_c_gen, inv_hor
from old_version.param import isolated_microgrids, unpaid_exp       # point 3 for sizing
